...
@Autonomous
public class RedDetection extends LinearOpMode
{
    ...
    public static class SkystoneDeterminationPipeline extends OpenCvPipeline
    {
        ...
        static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(60,160); // OR 60, 160
        static final Point REGION2_TOPLEFT_ANCHOR_POINT = new Point(240,160); // OR 240, 160
