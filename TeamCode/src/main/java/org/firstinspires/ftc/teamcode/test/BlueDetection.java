...
public class BlueDetection extends LinearOpMode
{
    ...
    public static class SkystoneDeterminationPipeline extends OpenCvPipeline
    {
        ...
        static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(100,160); // OR 60, 160
        static final Point REGION2_TOPLEFT_ANCHOR_POINT = new Point(270,160); // OR 240, 160
